...
#             nn.Linear(32*3*3, TOTAL_CLASSES//2),
...
# #         ************update 4/22************
#         self.fc1 = nn.Linear(48 * 3 * 3, 240)
#         self.fc2 = nn.Linear(240,160)
#         self.fc3 = nn.Linear(160, TOTAL_CLASSES)

#         ************update 4/23************
        self.fc1 = nn.Linear(100*2*2, 320)
        self.fc4 = nn.Linear(320,240)
        self.fc2 = nn.Linear(240,160)
        self.fc3 = nn.Linear(160, TOTAL_CLASSES)
...
#        ************update 4/23************
        x = self.pool3(F.relu(self.bn1(self.conv1(x))))
...
#         30*30*6 --> 15*15*6 ---> 13*13*16 --> 6*6*16 
#         --> 4*4*48 --> 2*2*60 ---> 240 -->160 -->100

#         30*30*6 --> 16*16*6 ---> 14*14*16 --> 8*8*16 
#         --> 6*6*48 --> 4*4*80----> 2*2*100 --> 320 --> 240 -->160 -->100

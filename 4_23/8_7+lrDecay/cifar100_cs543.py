...
train_transform = transforms.Compose(
    [transforms.ToTensor(), transforms.Normalize((0.48, 0.47, 0.43), (0.2,0.2,0.2))])
...
#         ************update 4/23************
#         self.fc1 = nn.Linear(60 * 4 * 4, 240)
        self.fc1 = nn.Linear(80*2*2, 240)
#         self.fc4 = nn.Linear(480,240)
        self.fc2 = nn.Linear(240,160)
        self.fc3 = nn.Linear(160, TOTAL_CLASSES)
        self.bn6 = nn.BatchNorm2d(80)
#         self.bn7 = nn.BatchNorm1d(480)
...
for epoch in range(EPOCHS):  # loop over the dataset multiple times
    ...
    running_loss = 0.0
    if (epoch >= 4):
            if abs((loss_doc[epoch-2]- loss_doc[epoch-1]))/loss_doc[epoch-2] <=0.025:
                    LR = LR/10
